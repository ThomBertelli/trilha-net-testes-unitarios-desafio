...
## Resultados após conclução do desafio  👨‍💻

- Testes do Service ValidacaoLista
![Testes Unitários Validações de Listas](Imagens/tests_dotnet_desafio_listas.png)
- Testes do Service ValidacaoString
![Testes Unitários Validações de Strings](Imagens/tests_dotnet_desafio_strings.png)
